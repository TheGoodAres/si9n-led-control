...
function loadControllerContent() {
    ...
    var content = "";
    const brightnessH = '<br><h2>Brightness</h2><br><input type="range" min="0" max="255" value="0" id="brightnessLevel"><span id="brightnessLevelSpan">0</span><button id="setBrightness">Set Brightness</button>';
