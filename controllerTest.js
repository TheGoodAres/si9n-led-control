...
class Controller {
    ...
    static changeBrightness(brightnessLevel) {
        if (isNumber(brightnessLevel)) {
            ...
            si9n.displayMessage({ raw: '55 AA 00 15 FE 00 01 FF FF FF 01 00 11 00 00 01 01 00 11 8B 59' });
        };
    };
...
function addInputs(controller) {
    var currentController = getControllerByName(controller);
    var container = document.getElementById("buttonContainer").innerHTML;
    console.log(container);
    console.log(currentController.inputs);
    Object.keys(currentController.inputs).forEach(command => {
